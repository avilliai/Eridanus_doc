...
#### 反向代理
反向代理配置难度较低，建议使用。建议自行搭建反向代理，[教程](https://simonmy.com/posts/%E4%BD%BF%E7%94%A8netlify%E5%8F%8D%E5%90%91%E4%BB%A3%E7%90%86google-palm-api.html)

你也可以去我们的q群913122269获取我们提供的免费反代地址。
```yaml
...
llm:
  ...
  enable_proxy: False
  gemini:    
    base_url: 反代地址  #参照上文自行搭建或在我们的群里获取
```
#### 正向代理
