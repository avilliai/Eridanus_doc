...
| 保存支持的数据类型 | **输入源**<br><br>音频、图片、视频和文本<br><br>**输出**<br><br>音频（即将推出）、图片（即将推出）和文本                                                                                                                                                                                                           |
| 令牌限制      | **输入令牌限制**<br><br>1,048,576<br><br>**输出令牌限制**<br><br>8192                                                                                                                                                                                                                      |
| 速率限制      | - 2,000 RPM<br>- 4,000,000 TPM                                                                                                                                                                                                                                                 |
| 功能        | **函数调用**<br><br>支持<br><br>**代码执行**<br><br>支持<br><br>**搜索**<br><br>支持<br> |
