...
class MailMan:
    ...
    async def set_group_admin(self,group_id: int,user_id: int,enable: bool):
        ...
        async with httpx.AsyncClient(headers=self.headers,timeout=200) as client:
            r = await client.post(url,json={"group_id":group_id,"user_id":user_id,"enable":enable})  # 使用 `json=data`
            return r.json()
    ...
    async def mute(self,group_id: int,user_id: int,duration: int):
        ...
        async with httpx.AsyncClient(headers=self.headers,timeout=200) as client:
            r = await client.post(url,json={"group_id":group_id,"user_id":user_id,"duration":duration})  # 使用 `json=data`
            return r.json()
    ...
    async def set_group_special_title(self,group_id: int,user_id: int,special_title: str):
        ...
        async with httpx.AsyncClient(headers=self.headers,timeout=200) as client:
            r = await client.post(url,json={"group_id":group_id,"user_id":user_id,"special_title":special_title})  # 使用 `json=data`
            return r.json()
    async def set_group_kick(self,group_id: int,user_id: int,reject_add_request: bool=True):
        ...
        async with httpx.AsyncClient(headers=self.headers,timeout=200) as client:
            r = await client.post(url,json={"group_id":group_id,"user_id":user_id,"reject_add_request":reject_add_request})  # 使用 `json=data`
            return r.json()
    ...
    async def _send_group_notice(self,group_id: int,content: str,image: str):
        ...
        async with httpx.AsyncClient(headers=self.headers,timeout=200) as client:
            r = await client.post(url,json={"group_id":group_id,"content":content,"image":image})  # 使用 `json=data`
            return r.json()
